...
class BottomBar extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, ScrollController controller, AnimationController animationController) body;
    ...
    return Stack(
      ...
      children: [
        BottomBarScrollControllerProvider(
          ...
          child: widget.body(context, scrollBottomBarController, _controller),
        ),
        if (widget.showIcon)
          Positioned(
